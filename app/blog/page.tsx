...
export const metadata = {
  ...
  description: "Technical insights, AI research, and software engineering thoughts by Rithy Bondeth.",
};
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <AnimateIn delay={0.1}>
          <p className="text-muted-foreground text-sm max-w-2xl mb-16 leading-relaxed">
            Sharing my journey through software engineering, AI research, and building digital products. 
            Expect deep dives, tutorials, and occasional rants about clean code.
          </p>
        </AnimateIn>
            ...
            <article key={post.slug} className="group relative">
              <div className="flex flex-col sm:flex-row sm:items-baseline gap-2 sm:gap-6">
                ...
                <div className="flex-1">
                  <Link href={`/blog/${post.slug}`} className="block group-hover:translate-x-1 transition-transform">
