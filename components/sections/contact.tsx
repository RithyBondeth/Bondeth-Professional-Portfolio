    ...
    <section id="contact" className="py-24 px-6 bg-slate-800">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <StaggerIn
          ...
          y={20}
        >
          <SocialLink href={siteConfig.github} label="GitHub" icon={<GitHubIcon />} />
          <SocialLink href={siteConfig.linkedin} label="LinkedIn" icon={<LinkedInIcon />} />
          <SocialLink href={`mailto:${siteConfig.email}`} label="Email" icon={<EmailIcon />} />
        </StaggerIn>
      </div>
    </section>
  );
