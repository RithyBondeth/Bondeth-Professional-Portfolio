...
export default function LandingHero(props: { lang: TLocale }) {
  ...
  return (
    ...
    >
      {/* No background layers of its own. The grid pattern is a single fixed
          layer in the root layout and shows through this section, as it does
          through every other one — the hero used to own a copy of the
          background, plus aurora orbs, a scan-line sweep, a centre glow and a
          vignette, and that stack both muddied the ground and was more than the
          compositor could carry alongside it. */}
