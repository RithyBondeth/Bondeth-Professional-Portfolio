...
export const projects: IProject[] = [
  {
    ...
    image: null,
    gradient: "from-sky-500/20 via-indigo-400/10 to-slate-900",
  },
  {
    slug: "apsara-talent",
    title: "Apsara Talent",
    ...
    visibility: "public",
    links: [
      { kind: "app", url: "https://apsaratalent.vercel.app" },
      { kind: "repo", url: "https://github.com/apsara-talent/apsara-talent" },
    ],
  ...
  },
  {
    ...
    visibility: "public",
    links: [
      { kind: "app", url: "https://apsara-assistant.vercel.app/" },
      { kind: "repo", url: "https://github.com/apsara-assistant/apsara-assistant" },
    ],
  ...
  },
  {
    ...
    visibility: "public",
    links: [
      { kind: "app", url: "https://apsara-agentic.vercel.app" },
      { kind: "repo", url: "https://github.com/apsara-agentic/apsara-agentic" },
    ],
  ...
  },
  {
    ...
    visibility: "public",
    links: [
      { kind: "app", url: "https://apsara-elearning.vercel.app" },
      { kind: "repo", url: "https://github.com/apsara-elearning/apsara-elearning-web" },
    ],
  ...
  },
  {
    ...
    visibility: "limited",
    links: [
      { kind: "app", url: "https://digitaleconomy.gov.kh/?lang=kh" },
    ],
  ...
  },
  {
    ...
    visibility: "limited",
    links: [
      { kind: "app", url: "https://informal.digitaleconomy.gov.kh/km" },
    ],
