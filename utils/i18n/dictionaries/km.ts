...
export const km: TDictionary = {
  ...
  projects: {
    ...
    practice: "ការងារអនុវត្តន៍ និងការងារដំបូង",
    practiceBlurb:
      "បង្កើតឡើងដើម្បីរៀនបច្ចេកទេស មិនមែនដើម្បីចេញផលិតផលទេ។ រក្សាទុកនៅទីនេះ ព្រោះដំណើរវិវត្តជាផ្នែកមួយនៃរឿងរ៉ាវ។",
    filterDomain: "វិស័យ",
  ...
  labs: {
    ...
    playground: {
      ...
      presets: [
        ...
        },
        {
          ...
          value: "យើងកំពុងពិចារណាបង្កើតគេហទំព័រសម្រាប់អង្គការរបស់យើងនៅខែក្រោយ។",
        },
      ],
      steps: [
        {
        ...
        },
        {
          ...
          description: "បម្លែងពាក្យផ្សេងៗទៅជាតម្លៃសេវា និងភាពបន្ទាន់ដែលថេរ។",
        },
        {
          title: "ផ្ទៀងផ្ទាត់",
          description:
    ...
    rag: {
      ...
      emptyResults: "ដំណើរការការស្វែងរក ដើម្បីមើល chunk ដែលនឹងត្រូវផ្ញើទៅ LLM។",
      noMatches:
      ...
      steps: [
        {
          title: "បំបែកពាក្យ",
          description: "បម្លែងសំណួរទៅជាពាក្យដែលអាចស្វែងរក និងដកពាក្យទូទៅចេញ។",
        },
        {
    ...
    evals: {
      ...
      steps: [
        ...
        },
        {
          ...
          description: "ដំណើរការ grader ដូចគ្នាលើ baseline និងចម្លើយថ្មី។",
        },
        {
          title: "ចាប់ Regression",
          description: "ពិនិត្យតេស្តដែលបរាជ័យ ជំនួសឱ្យការជឿលើពិន្ទុសរុបតែមួយ។",
        },
      ],
      relatedReading: "អត្ថបទបច្ចេកទេសពាក់ព័ន្ធ",
  ...
  cluster: {
    heading: "// ប្រធានបទនេះ ក្នុងគ្រប់ទម្រង់",
    blurb:
      "គំនិតតែមួយ ក្នុងកម្រិតបីផ្សេងគ្នា — ការពន្យល់ ៦០ វិនាទី អត្ថបទពេញលេញ និងអ្វីដែលអ្នកអាចសាកល្បងដោយផ្ទាល់។",
    formats: {
      note: "កំណត់ត្រា ៦០ វិនាទី",
      post: "អត្ថបទលម្អិត",
      project: "គម្រោង",
      lab: "មន្ទីរពិសោធន៍",
      video: "វីដេអូ",
  ...
  blogFormats: {
    ...
    all: "ទាំងអស់",
    note: "កំណត់ត្រា ៦០ វិនាទី",
    article: "អត្ថបទលម្អិត",
  },
  media: {
    label: "// channel.md",
    heading: "របៀបដែលវាដំណើរការជាក់ស្តែង",
    blurb:
      "ខ្ញុំធ្វើវីដេអូបច្ចេកទេសជាភាសាអង់គ្លេស និងខ្មែរ — ពន្យល់គំនិតនៅពីក្រោយប្រព័ន្ធដែលខ្ញុំធ្វើការជាមួយ សម្រាប់អ្នកទស្សនាដែលភាគច្រើនមិនទាន់មានឯកសារបែបនេះជាភាសាខ្លួនឯង។",
    playLabel: "ចាក់វីដេអូ",
    loadNotice:
      "ការចាក់វីដេអូនឹងផ្ទុកកម្មវិធីចាក់ពី YouTube ដែលនឹងកំណត់ខូឃីរបស់ខ្លួន។",
    watchOnYouTube: "មើលនៅលើ YouTube",
    subscribe: "ទស្សនាឆានែល",
    readPost: "អានជាអត្ថបទ",
    languageBadge: { en: "អង់គ្លេស", km: "ខ្មែរ" },
  },
  recommendations: {
  ...
  contact: {
    ...
    form: {
      ...
      networkError:
        "មិនអាចភ្ជាប់ទៅម៉ាស៊ីនមេបានទេ។ សូមពិនិត្យការតភ្ជាប់របស់អ្នក ហើយព្យាយាមម្តងទៀត។",
    },
  },
  footer: {
    navigation: "ការរុករក",
  ...
  blog: {
    formatNote: "កំណត់ត្រា ៦០ វិនាទី",
    originallyOn: "ដើមឡើយនៅ",
    ...
    browseCategories: "រកមើលតាមប្រភេទ",
  ...
  resume: {
    ...
    heading: "ប្រវត្តិរូប",
    blurb:
      "ខ្លឹមសារដូចគ្នានឹងឯកសារ PDF ដែលអាចអានបានលើគ្រប់អេក្រង់ និងជាពីរភាសា។ បោះពុម្ពទំព័រនេះ ដើម្បីទទួលបានច្បាប់ចម្លងសម្រាប់ក្រដាស។",
    ...
    email: "អ៊ីមែល",
    location: "ទីតាំង",
    locationValue: "រាជធានីភ្នំពេញ ប្រទេសកម្ពុជា (UTC+7)",
    website: "គេហទំព័រ",
    printedFrom: "បោះពុម្ពពី",
  },
  commandPalette: {
    open: "ស្វែងរក",
    ...
    downloadResume: "ទាញយកប្រវត្តិរូប (PDF)",
