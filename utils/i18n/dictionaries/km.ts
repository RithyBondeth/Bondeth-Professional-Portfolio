...
export const km: TDictionary = {
  ...
  projects: {
    government: "វិស័យសាធារណៈ",
    governmentBlurb:
      "វេទិកាដែលបង្កើតឡើងសម្រាប់ស្ថាប័នរដ្ឋាភិបាលកម្ពុជា។ ព័ត៌មានទាំងនេះជាសាធារណៈតែប៉ុណ្ណោះ — ស្ថាបត្យកម្មខាងក្នុង និងព័ត៌មានប្រតិបត្តិការនៅតែរក្សាជាឯកជន។",
    relatedProjects: "គម្រោងពាក់ព័ន្ធ",
    previousProject: "គម្រោងមុន",
    nextProject: "គម្រោងបន្ទាប់",
    outcome: "លទ្ធផល",
